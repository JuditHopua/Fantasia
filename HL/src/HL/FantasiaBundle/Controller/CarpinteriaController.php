...
class CarpinteriaController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('carpinteria_show', array('id' => $entity->getId())));
        }
    ...
    */
     ...
     *
     * @Route("/{id}", name="carpinteria_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('carpinteria_delete', array('id' => $id)))
            ->setMethod('DELETE')
